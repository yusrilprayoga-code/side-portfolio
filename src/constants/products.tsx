export const products = [
  {
    ...
    content: (
      <div>
        <p>
          B-Otomotif is a cutting-edge website that complements its popular
          YouTube channel, focusing on the latest developments in the automotive
          world. The site is dedicated to car enthusiasts, offering
          comprehensive and in-depth content about new car models, detailed
          reviews, and insightful discussions. Visitors can explore a variety of
          articles, videos, and features that provide a closer look at the
          newest vehicles on the market, making B-Otomotif a go-to resource for
          anyone passionate about cars.{" "}
        </p>
        <p>
          The website is sleek and user-friendly design ensures an engaging
          experience, allowing users to easily navigate through the wealth of
          information available. With a strong emphasis on high-quality content,
          B-Otomotif not only highlights the technical specifications and
          performance of new cars but also delves into their design, innovation,
          and market impact. This holistic approach ensures that readers and
          viewers are well-informed, making B-Otomotif an essential destination
          for staying up-to-date with the latest trends and advancements in the
          automotive industry.
        </p>{" "}
      </div>
    ),
  },
  {
    ...
    images: [
      ...
      "/images/sidefolio-carshowroom-2.png",
    ],
